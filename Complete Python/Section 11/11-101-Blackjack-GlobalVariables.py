...
def deal_player():
    player_score = 0  # as soon as you assign a new value to a global variable, python changes it to a local variable
    card_value = deal_card(player_card_frame)[0]
    if card_value == 1 and not player_ace:
        card_value = 11
    player_score += card_value
    # if we went bust, check if there is an ace and subtract
