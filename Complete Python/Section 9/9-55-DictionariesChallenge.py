...
while True:
    ...
    print()
    # Parse user input using vocabulary dictionary if necessary
    if len(direction) > 1:
        words = direction.split()               # using the .split method to parse the input and avoid
        for word in words:                      # traversing entire vocabulary dictionary with each input
